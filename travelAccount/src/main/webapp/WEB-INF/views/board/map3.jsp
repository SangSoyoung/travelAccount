        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="부산역" id="keyword" size="15"> 
...
kakao.maps.event.addListener(map, 'click', function(mouseEvent) {        
    ...
    var message = '클릭한 위치의<br>'
    message += '위도값 : ' + '<input type="text" name="plat" value="'+plat+'" >';
    message += '경도값 : ' + '<input type="text" name="plng" value="'+plng+'" >';
