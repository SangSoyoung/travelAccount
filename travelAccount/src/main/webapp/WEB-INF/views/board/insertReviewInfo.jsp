                ...
                <div class="container px-5">
                    ...
                    <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                        <div class="text-center mb-5">
                            <h3 class="fw-bolder">게시물 등록 페이지</h3>
                        </div>
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                                ...
                                <form role='form' action="/board/insertReviewInfo" method="post" id="contactForm" >

                                    <div class="form-floating mb-3">
                                        <input type="text" name="title" class="form-control" />
                                        <label for="title">제목 입력란</label>
                                    </div>
                                    ...
                                    <div class="form-floating mb-3" style="clear:both;">
                                        <textarea type="text" name="content" class="form-control" style="height: 10rem"></textarea>
                                        <label for="content">내용을 입력란</label>
                                    </div>
									
									
									<!-- 지도 Modal 버튼 -->
                                    <div class="form-floating mb-3 map-modal">
										<button type="button" class="modalMapBtn btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
										  지도추가
										</button>
                                    ...
                                    <!-- 작성자 -->
                                    <input type="text" name="writer" value="aaa" readonly>
                                    <br><br>
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLabel">지도추가</h5>
...
$("#exampleModal").on('shown.bs.modal', function(e){
	setTimeout(function () { // 비동기 호출
        map.relayout();
        map.setCenter(new kakao.maps.LatLng(35.16031625361409, 129.07303800285757));
...
<script type="text/javascript">
	...
	$(document).ready(function(e){
		...
		$("#cancelBtn").on("click", function(){
			self.location = "/board/reviewInfoBoard";
		});
